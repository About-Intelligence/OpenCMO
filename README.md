...
The most useful file in the repo is [deep-insights.md](references/guides/deep-insights.md): ten patterns you can only see with all the operators side by side. A sample:
